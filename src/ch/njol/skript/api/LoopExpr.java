...
/**
 * An expression that can be looped.<br/>
 * This class implements Expression, thus has the {@link Expression#change(Event, Expression, ChangeMode)} method which has an event argument.
 * You usually don't need it for the expression itself, what you need is {@link #current()}.
 * 
 * @author Peter Güttinger
 * 
 */
public abstract class LoopExpr<T> extends SimpleExpression<T> {
	
	/**
	 * holds information about a loop expression
	 * 
	 * @author Peter Güttinger
	 * 
	 */
	public static class LoopInfo<E extends LoopExpr<T>, T> extends ExpressionInfo<E, T> {
