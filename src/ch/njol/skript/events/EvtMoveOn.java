...
public class EvtMoveOn extends SkriptEvent {
	...
	static {
//		Skript.registerEvent(EvtMoveOn.class, PlayerMoveEvent.class, false, "(step|walk) on <.+>");
	}
	...
	public boolean init(final Literal<?>[] args, final int matchedPattern, final ParseResult parser) {
		...
		if (m.matches()) {
			...
			final Literal<? extends ItemType> l = SkriptParser.parseLiteral(parser.regexes.get(0).group(), ItemType.class, ParseContext.EVENT);
			if (l == null)
				return false;
			types = l.getAll();
